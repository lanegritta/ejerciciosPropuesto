...
# Solicitar el estado del cargador
    mouse = input("Ingrese el estado del mouse: ")  
# Solicitar el estado del mouse
...
def agregarNovedad():
    ...
    # Solicitar la fecha de la novedad
        descripcion = input("Ingrese la descripción de la novedad: ") 
    # Solicitar la descripción de la novedad
...
while True:
    ...
    # Llama a la funcion para agregar un equipo
        ...
        agregarNovedad() 
    # Llama a la funcion para agregar una novedad
    elif opcion == "3":
        mostrarEquipos() 
    # Llama a la funcion para mostrar equipos
    elif opcion == "4":
        mostrarNovedades()  
    # Llama a la funcion para mostrar novedades
    elif opcion == "5":
        modificarEquipo()  
    # Llama a la funcion para modificar un equipo
    elif opcion == "6":
        eliminarEquipo()  
    # Llama a la funcion para eliminar un equipo
    elif opcion == "7":
        break  
    # Salir del bucle principal si el usuario selecciona la opción "7"
    else:
